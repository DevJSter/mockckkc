...
const GlobalChart = ({ display }) => {
  ...
  return chartDataFiltered ? (
    <>
      {below800 && (
        <DropdownSelect options={CHART_VIEW} active={chartView} setActive={setChartView} color={'#00BCD4'} />
      )}
      ...
      {chartDataFiltered && chartView === CHART_VIEW.LIQUIDITY && (
        <ResponsiveContainer aspect={60 / 28} ref={ref}>
          <TradingViewChart
            ...
            baseChange={typeof(liquidityChangeUSD) !== 'undefined' && liquidityChangeUSD !== null && liquidityChangeUSD !=='' ? liquidityChangeUSD : 0}
            title="Liquidity"
      ...
      {chartDataFiltered && chartView === CHART_VIEW.VOLUME && (
        <ResponsiveContainer aspect={60 / 28}>
          <TradingViewChart
            ...
            baseChange={volumeWindow === VOLUME_WINDOW.WEEKLY ? weeklyVolumeChange : typeof(volumeChangeUSD) !== 'undefined' && volumeChangeUSD !== null && volumeChangeUSD !=='' ? volumeChangeUSD : 0}
