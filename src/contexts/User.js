  ...
  useEffect(() => {
    async function fetchData(account) {
      try {
        ...
        miningPositionData = [
          {
            miningPool: { pair: { id: '0xMockPairAddress1' } },
            pairData: allPairData['0xMockPairAddress1'],
          },
          {
            miningPool: { pair: { id: '0xMockPairAddress2' } },
            pairData: allPairData['0xMockPairAddress2'],
          },
        ]
